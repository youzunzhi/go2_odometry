...
class FakeOdometryNode(Node):
    ...
    def publish_odom_cb(self):
        ...
        transform_msg.transform.translation.x, transform_msg.transform.translation.y = 0., 0.
        transform_msg.transform.translation.z = self.get_parameter("base_height").value
        transform_msg.transform.rotation.x, transform_msg.transform.rotation.y, transform_msg.transform.rotation.z, transform_msg.transform.rotation.w  = 0., 0., 0., 1.
        ...
        odometry_msg.pose.pose.position.x, odometry_msg.pose.pose.position.y = 0., 0.
        odometry_msg.pose.pose.position.z = self.get_parameter("base_height").value
        odometry_msg.pose.pose.orientation.x, odometry_msg.pose.pose.orientation.y, odometry_msg.pose.pose.orientation.z, odometry_msg.pose.pose.orientation.w  = 0., 0., 0., 1.
        odometry_msg.twist.twist.linear.x, odometry_msg.twist.twist.linear.y, odometry_msg.twist.twist.linear.z = 0., 0., 0.
        odometry_msg.twist.twist.angular.x, odometry_msg.twist.twist.angular.y, odometry_msg.twist.twist.angular.z = 0., 0., 0.
